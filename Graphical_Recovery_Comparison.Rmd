...
graph_recovery = Test_tibble_final |>
  ...
  summarise(
    ...
    global_detect_11_tv = any(a == 1 & c == 1 & r > 1 & global_BY_min < alpha),
...
,
    ...
    twostep_detect_11_tv = any(a == 1 & c == 1 & r > 1 & twostep_BY < alpha),
...
overall_accuracy = tibble(
  ...
  # All true edges detected (but may have false positives)
  All_True_Detected = c(
